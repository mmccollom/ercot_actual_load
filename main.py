...
def execute():
    report_type_id = '14836'
    s3_path = 's3://ercot-62841215/actual_load/'
    ...
    for document in documents_dict:
        ...
        # rename columns
        col_remap = {'OperDay': 'delivery_date', 'HourEnding': 'hour_ending', 'NORTH': 'north', 'SOUTH': 'south',
                     'WEST': 'west', 'HOUSTON': 'houston', 'DSTFlag': 'is_day_light_savings', 'TOTAL': 'system_total'}
